...
export function useAssetManager(currentUser: UserObject | null, bucketName: string | null) {
  ...
  const loadList = useCallback(async (showUserFiles: boolean) => {
